...
```sh
$ npm install --save-dev eslint eslint-plugin-svelte3 @babel/core @babel/eslint-parser @babel/cli @babel/preset-env
```

2. create config file babel.config.json
...
3. Compile code from src directory to lib
