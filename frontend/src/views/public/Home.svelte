  ...
  async function register() {
    ...
    try {
      ...
      registrationSuccessMessage =
        'Thank you for registering, rediring to login...'
      await new Promise((f) => {
        setTimeout(f, 1800)
      }) // 1.8 second timeout
  ...
  const checkPassword = () => {
    ...
    if (!registrationForm.password.match(regEx)) {
      return {
        valid: false,
        message:
          'Password must be 8 characters in length and contain a combination of upper case letters, lower case letters and numbers or special characters',
      }
    }
            ...
            <div class="field is-grouped">
              <div class="control">
                <button
                  ...
                  class="button is-link is-outlined">Next</button
                >
              </div>
            </div>
          {:else if step === 2}
            <div id="passwordBlock" in:fly={{ x: 400, duration: 1000 }}>
              ...
              <div class="field is-grouped">
                <div class="control">
                  <button
                    on:click={() => register()}
                    class="button is-link is-outlined">Submit</button
                  >
                </div>
              </div>
            </div>
